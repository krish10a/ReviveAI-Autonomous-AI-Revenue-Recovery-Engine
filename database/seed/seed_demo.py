    ...
    try:
        ...
        for i, sc in enumerate(scenarios):
            ...
            seeded_summary.append({
                ...
                "status": payment.status.value,
                "failure_category": sc["failure_category"] or "captured_clean",
            })
        ...
        for item in seeded_summary:
            print(f"  [{item['scenario_index']}] {item['scenario_key']}: Case #{item['case_id']}, INR {item['amount']:.2f}, Category: {item['failure_category']}")
        print("===================================================\n")
